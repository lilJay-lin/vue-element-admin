        ...
        <div class="__item__" v-for="(file,key) in safeFiles" v-if="!file.done" :key="key">
          ...
          <div class="__name__">
            <svg viewBox="0 0 1024 1024">
              <path
                d="M636.974339 66.552765 139.739625 66.552765l0 890.583384 742.153844 0L881.893468 304.049854 636.974339 66.552765 636.974339 66.552765zM591.950913 348.826664 591.950913 125.932154 822.506916 348.826664 591.950913 348.826664 591.950913 348.826664zM591.950913 348.826664"></path>
            </svg>
            {{file.name}}
          </div>
          ...
          <div class="__success__" v-if="file.progress==100">
            <svg viewBox="0 0 1024 1024">
              <path
                d="M512 0C229.239467 0 0 229.239467 0 512s229.239467 512 512 512 512-229.239467 512-512S794.760533 0 512 0z m-68.778667 699.733333l-0.170666-0.136533-0.1536 0.136533L238.933333 490.376533l35.328-34.594133 168.789334 157.934933L752.298667 324.266667 785.066667 359.287467 443.221333 699.733333z"></path>
            </svg>
          </div>
        </div>
      </transition-group>
